...
import { GET_ERRORS, BUY_STOCK, SELL_STOCK, UPDATE_STOCKS } from "./types";
...
export const buyStock = (userData, tradeInfo) => (dispatch) => {
    axios
        ...
        .then((res) => {
            ...
            axios.post("/api/users/buyStock", tradeData).then((res) => {
...
export const sellStock = (userData, tradeInfo) => (dispatch) => {
    axios
        ...
        .then((res) => {
            ...
            axios.post("/api/users/sellStock", tradeData).then((res) => {
...
export const updateStocks = (userData) => (dispatch) => {
    ...
    axios.post("/api/users/updateStocks", data).then((res) => {
